...
class vpnlib
    ...
    configurevpn: (filename, callback) ->        
        ...
        fileops.createFile filename, (result) ->
            ...
            if @request # added by geetha to support /management/tunnel endpoint
    ...
    configClient: (filename, callback) -> 
        # commented below 2 lines to support openvpn client       
        #if filename = ''
    ...
    delUser: (callback) ->
        ...
        console.log " userid:" + userid + entry.email
        try
